...
public class MtkConnection {
    ...
    public static final String EVENT_CDMA_CALL_ACCEPTED =
            "mediatek.telecom.event.CDMA_CALL_ACCEPTED";
    ...
    /**
     * Connection event used to inform an {@link InCallService} that the RTT speech indication
     * has changed.
     */
    public static final String EVENT_RTT_SPEECH_INDICATION_CHANGED =
            "mediatek.telecom.event.RTT_SPEECH_INDICATION_CHANGED";
     ...
     * {@link Connection#sendConnectionEvent} which indicates that speech is present
     * on the RTT call when the extra value is true.
     */
    public static final String EXTRA_IS_RTT_SPEECH_PRESENT =
            "mediatek.telecom.extra.IS_RTT_SPEECH_PRESENT";
