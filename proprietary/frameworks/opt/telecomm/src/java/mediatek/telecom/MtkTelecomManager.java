...
public class MtkTelecomManager {
    ...
    /// MTK GTT (Global Text Telephony) related @{
    /**
     * Optional extra for put GTT (Global Text Telephony) local mode value
     *
     * @hide
     */
    public static final String EXTRA_GTT_MODE_LOCAL =
            "mediatek.telecom.extra.GTT_MODE_LOCAL";

    /**
     * Optional extra for put GTT (Global Text Telephony) remote mode value
     *
     * @hide
     */
    public static final String EXTRA_GTT_MODE_REMOTE =
            "mediatek.telecom.extra.GTT_MODE_REMOTE";

    /**
     * event string to update GTT (Global Text Telephony) mode change to Telecom
     * Sent to Telecom via {@link #sendConnectionEvent(String)}
     *
     * @hide
     */
    public static final String EVENT_GTT_MODE_CHANGED =
            "mediatek.telecom.event.GTT_MODE_CHANGED";
