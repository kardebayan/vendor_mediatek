...
public class MtkTelecomHelper {
    ...
    public static class MtkInCallServiceHelper {
        ...
        /// M: For [Digits] deviceSwitch function support. @{
        public static Bundle buildParamsForDeviceSwitch(String callId, String number,
                String deviceId) {
            return obtainBuilder(ACTION_DEVICE_SWITCH)
                    .putStringParam(PARAM_STRING_CALL_ID, callId)
                    .putStringParam(PARAM_STRING_PHONE_NUMBER, number)
                    .putStringParam(PARAM_STRING_DEVICE_ID, deviceId)
                    .build();
        }

        public static Bundle buildParamsForCancelDeviceSwitch(String callId) {
            return obtainBuilder(ACTION_CANCEL_DEVICE_SWITCH)
                    .putStringParam(PARAM_STRING_CALL_ID, callId)
                    .build();
        }
        /// @}
    ...
    public static class MtkInCallAdapterHelper {
        ...
        public static void handleExtCommand(Bundle params, ICommandProcessor processor) {
            ...
            switch (action) {
                ...
                case MtkInCallServiceHelper.ACTION_STOP_VOICE_RECORDING:
                    ...
                    break;
                /// M: For [Digits] deviceSwitch function support. @{
                case MtkInCallServiceHelper.ACTION_DEVICE_SWITCH:
                    callId = params.getString(MtkInCallServiceHelper.PARAM_STRING_CALL_ID);
                    String number = params.getString(
                            MtkInCallServiceHelper.PARAM_STRING_PHONE_NUMBER);
                    String deviceId = params.getString(
                            MtkInCallServiceHelper.PARAM_STRING_DEVICE_ID);
                    processor.deviceSwitch(callId, number, deviceId);
                    break;
                case MtkInCallServiceHelper.ACTION_CANCEL_DEVICE_SWITCH:
                    callId = params.getString(MtkInCallServiceHelper.PARAM_STRING_CALL_ID);
                    processor.cancelDeviceSwitch(callId);
                    break;
                /// @}
                /// Reject call with cause.
        ...
        public static interface ICommandProcessor {
            ...
            /// M: For [Digits] deviceSwitch function support. @{
            void deviceSwitch(String callId, String number, String deviceId);

            void cancelDeviceSwitch(String callId);
            /// @}
