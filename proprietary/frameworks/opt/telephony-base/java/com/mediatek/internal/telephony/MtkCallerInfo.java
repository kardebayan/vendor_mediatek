...
public class MtkCallerInfo extends CallerInfo {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (columnIndex != -1) {
                    ...
                    if (typeColumnIndex != -1) {
                        ...
                        /// M: CC: CallerInfo OP Plugin @{
                        try {
                            IMtkCallerInfoExt iCallerInfoExt = MtkOpTelephonyCustomizationUtils
                                    .getOpFactory(context).makeMtkCallerInfoExt();
    ...
    public static CallerInfo getCallerInfo(Context context, String number, int subId) {
        ...
        if (MtkPhoneNumberUtils.isEmergencyNumberExt(number, phoneType)) {
            CallerInfo info = new MtkCallerInfo().markAsEmergency(context);
