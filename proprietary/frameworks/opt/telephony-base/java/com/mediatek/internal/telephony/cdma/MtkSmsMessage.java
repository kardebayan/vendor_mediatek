...
public class MtkSmsMessage extends SmsMessage {
    ...
    public SmsCbMessage parseBroadcastSms() {
        BearerData bData = MtkBearerData.decode(mEnvelope.bearerData, mEnvelope.serviceCategory);
        if (bData == null) {
    ...
    private static String handlePlusCodeInternal(int ton, String number) {
        ...
        Rlog.d(LOG_TAG, "handlePlusCodeInternal, after handled, the address = " + ret);
        return ret;
    }
