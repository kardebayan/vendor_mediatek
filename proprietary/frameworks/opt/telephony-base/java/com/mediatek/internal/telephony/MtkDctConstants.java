...
public class MtkDctConstants extends DctConstants {
    ...
    public static final int APN_WAP_ID = 10;
    public static final int APN_XCAP_ID = 11;
    public static final int APN_RCS_ID = 12;
    public static final int APN_BIP_ID = 13;
    public static final int APN_VSIM_ID = 14;
    public static final int APN_PREEMPT_ID = 15;

    public static final int APN_NUM_TYPES = APN_PREEMPT_ID + 1;
}
