...
import android.telephony.ims.ImsCallSession.Listener;
...
public class OpImsCallSessionBase {
    ...
    public OpImsCallSessionBase() {
    }

    public void callSessionTextCapabilityChanged(Listener listener,
            MtkImsCallSession session,
    ...
    public void callSessionRttEventReceived(Listener listener,
            MtkImsCallSession session, int event) {
