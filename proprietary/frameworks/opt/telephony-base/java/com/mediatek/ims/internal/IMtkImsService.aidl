...
interface IMtkImsService {
    ...
    IMtkImsCallSession createMtkCallSession(int serviceId, in ImsCallProfile profile,
            in IImsCallSessionListener listener, in IImsCallSession aospCallSessionImpl);

    IMtkImsCallSession getPendingMtkCallSession(String callId);
     ...
     */
    void hangupAllCall(int serviceId);
