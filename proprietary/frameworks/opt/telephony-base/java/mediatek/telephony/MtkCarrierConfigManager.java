...
public class MtkCarrierConfigManager {
    ...
    */
    ...
    /**
     * Added to support RTT advanced features, merge, video call..., currently only AT&T support.
     * @hide
     */
    public static final String MTK_KEY_RTT_ADVANCED_FEATURES_SUPPORT_BOOL =
            "mtk_rtt_advanced_features_support_bool";
    ...
    public static void putDefault(PersistableBundle sDefaults) {
        ...
        // M: Added to support RTT advanced features.
        sDefaults.putBoolean(MTK_KEY_RTT_ADVANCED_FEATURES_SUPPORT_BOOL, false);
        ...
        //M: Default no need to check volte enabled for video call over wifi enable.
