...
public class MtkCdmaSMSDispatcher extends CdmaSMSDispatcher {
    ...
    protected SmsMessageBase.SubmitPduBase onGetNewSubmitCdmaPduTracker(
        ...
        return MtkSmsMessage.getSubmitPdu(scAddress,
                destinationAddress, message, (deliveryIntent != null) && lastPart,
                smsHeader, encoding, validityPeriod, priority,
                (UserData.ENCODING_7BIT_ASCII == get7bitEncodingType()));
    }
    ...
    public void sendData(String destAddr, String scAddr, int destPort, int originalPort,
        ...
        sendData(destAddr, scAddr, destPort,
