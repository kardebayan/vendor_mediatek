...
import com.mediatek.internal.telephony.dataconnection.MtkApnSetting;
...
public class MtkTelephonyComponentFactory extends TelephonyComponentFactory {
    ...
    public DcTracker makeDcTracker(Phone phone) {
        return new MtkDcTracker(phone, TransportType.WWAN);
    }
    ...
    public TelephonyNetworkFactory makeTelephonyNetworkFactories(PhoneSwitcher phoneSwitcher,
        ...
        return new MtkTelephonyNetworkFactory(phoneSwitcher, subscriptionController,
    ...
    */
    ...
    public IccInternalInterface makeIccProvider(UriMatcher urlMatcher, Context context) {
        Rlog.d(LOG_TAG , "makeIccProvider mtk");
        return new MtkIccProvider(urlMatcher, context);
    }
    // PHB END
    ...
    */
    ...
    public DataConnection makeDataConnection(Phone phone, String name, int id,
        ...
        DataConnection dc = new MtkDataConnection(phone, "Mtk" + name, id, dct, dataServiceManager,
                failBringUpAll, dcc);
    ...
    public DcAsyncChannel makeDcAsyncChannel(DataConnection dc, String logTag) {
        return new MtkDcAsyncChannel(dc, logTag);
    }
    ...
    public DcController makeDcController(String name, Phone phone, DcTracker dct,
        ...
        return new MtkDcController("Mtk" + name, phone, dct, dataServiceManager, handler);
    }
    ...
    public ImsServiceController makeStaticImsServiceController(Context context,
        ...
        return new MtkImsServiceControllerCompat(context, componentName, callbacks);
    }
