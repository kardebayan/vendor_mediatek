...
public class MtkTelephonyNetworkFactory extends TelephonyNetworkFactory {
    ...
    private boolean mPdnActivation = false;

    public MtkTelephonyNetworkFactory(PhoneSwitcher phoneSwitcher,
        ...
        super(phoneSwitcher, subscriptionController, subscriptionMonitor, looper, context, phoneId,
                dcTracker);
    }
    ...
    protected NetworkCapabilities makeNetworkFilter(int subscriptionId) {
        ...
        nc.addCapability(NetworkCapabilities.NET_CAPABILITY_PREEMPT);
        return nc;
    }
