...
public class DataSubSelector {
    ...
    private IDataSubSelectorOPExt mDataSubSelectorOPExt = null;
    ...
    public void syncDefaultDataToMd(int phoneId) {
        int defaultSubId = MtkSubscriptionManager.getSubIdUsingPhoneId(phoneId);
                ...
                if (subInfoList.size() == 1) {
                    ...
                    for (int index = 0; index < subInfoList.size(); index ++) {
                        ...
                        if (tempSubId == subId) {
                            ...
                            updateNetworkModeUtil(tempSubId, Phone.NT_MODE_WCDMA_PREF);
                        }
                    }
                }
            }
