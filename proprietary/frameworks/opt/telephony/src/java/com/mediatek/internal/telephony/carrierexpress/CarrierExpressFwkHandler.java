    ...
    private final BroadcastReceiver mCarrierExpressReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (CarrierExpressManager.ACTION_CXP_RESET_MODEM.equals(action)) {
                ...
                mCi.setOperatorConfiguration(MtkRILConstants.CXP_CONFIG_TYPE_OPTR,
                    intent.getStringExtra("OPTR"), null);
                mCi.setOperatorConfiguration(MtkRILConstants.CXP_CONFIG_TYPE_SPEC,
                    intent.getStringExtra("SPEC"), null);
                mCi.setOperatorConfiguration(MtkRILConstants.CXP_CONFIG_TYPE_SEG,
                    intent.getStringExtra("SEG"), null);
                mCi.setOperatorConfiguration(MtkRILConstants.CXP_CONFIG_TYPE_SBP,
                    intent.getStringExtra("SBP"), null);
                mCi.setOperatorConfiguration(MtkRILConstants.CXP_CONFIG_TYPE_SUBID,
