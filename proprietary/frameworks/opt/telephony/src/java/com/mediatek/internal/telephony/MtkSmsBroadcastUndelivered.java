...
public class MtkSmsBroadcastUndelivered extends SmsBroadcastUndelivered {
    ...
    private void scanRawTable(Context context, boolean isCurrentFormat3gpp2) {
        ...
        try {
            ...
            String nonDeleteWhere = "deleted = 0"
                    + (isCurrentFormat3gpp2 ? IMtkConcatenatedSmsFwk.SQL_3GPP2_SMS :
            ...
            while (cursor.moveToNext()) {
                ...
                try {
                    tracker = (MtkInboundSmsTracker)
                            (TelephonyComponentFactory.getInstance().makeInboundSmsTracker(cursor,
