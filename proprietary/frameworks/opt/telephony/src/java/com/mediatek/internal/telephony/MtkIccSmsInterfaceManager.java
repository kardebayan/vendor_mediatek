...
public class MtkIccSmsInterfaceManager extends IccSmsInterfaceManager {
            ...
            switch (msg.what) {
                ...
                case EVENT_GET_SMSC_ADDRESS_DONE:
                    ...
                    synchronized (mMtkLock) {
                        if (ar.exception == null) {
                            ...
                            if (DBG) log("SMSC address " + mSmscAddress);
                        } else {
                ...
                case EVENT_GET_SMSC_ADDRESS_BUNDLE_DONE:
                    ...
                    synchronized (mMtkLock) {
                        ...
                        if (ar.exception == null) {
                            if (DBG) log("SMSC address " + (String) ar.result);
    ...
    protected void sendTextInternal(String callingPackage, String destAddr, String scAddr,
            ...
            int validityPeriod) {
        log("sendTextMessage, text=" + ((DBG == true)? text : "") +
    ...
    protected void sendDataInternal(String destAddr, String scAddr,
            int destPort, byte[] data, PendingIntent sentIntent, PendingIntent deliveryIntent) {
        log("sendDataMessage, destinationAddress=" + destAddr);
        ...
        super.sendDataInternal(destAddr, scAddr, destPort, data, sentIntent, deliveryIntent);
    }
    ...
    public void sendDataWithOriginalPort(String callingPackage, String destAddr, String scAddr,
        ...
        if (checkPermission) {
            ...
            if (Rlog.isLoggable("SMS", Log.VERBOSE)) {
                log("sendData: destAddr=" + destAddr + " scAddr=" + scAddr + " destPort=" +
                    destPort + " originalPort=" + originalPort + " data='" +
                    HexDump.toHexString(data) + "' sentIntent=" + sentIntent +
        ...
        ((MtkSmsDispatchersController)mDispatchersController).sendData(
    ...
    public void sendMultipartText(String callingPackage, String destAddr, String scAddr,
        ...
        log("sendMultipartTextMessage, destinationAddress=" + destAddr);
    ...
    public void sendMultipartData(
        ...
        ((MtkSmsDispatchersController)mDispatchersController).sendMultipartData(destAddr, scAddr,
                destPort, (ArrayList<SmsRawData>) data, (ArrayList<PendingIntent>) sentIntents,
    ...
    public String getScAddress() {
        ...
        log("getScAddress: exit with " + mSmscAddress);
        return mSmscAddress;
    }
    ...
    public boolean setScAddress(String address) {
        if (DBG) log("setScAddressUsingSubId(" + address + ')');
