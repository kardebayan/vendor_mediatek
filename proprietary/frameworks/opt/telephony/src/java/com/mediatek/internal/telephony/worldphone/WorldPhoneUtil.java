...
//C2K world phone start
    ...
    */
    ...
    public static String stateToString(int state) {
        String stateString;
        switch (state) {
            case MtkServiceState.STATE_POWER_OFF:
                stateString = "STATE_POWER_OFF";
                break;
            case MtkServiceState.STATE_IN_SERVICE:
                stateString = "STATE_IN_SERVICE";
                break;
            case MtkServiceState.STATE_OUT_OF_SERVICE:
                stateString = "STATE_OUT_OF_SERVICE";
                break;
            case MtkServiceState.STATE_EMERGENCY_ONLY:
