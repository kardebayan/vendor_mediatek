...
public class MtkIPv6TetheringCoordinator extends IPv6TetheringCoordinator {
    ...
    public MtkIPv6TetheringCoordinator(ArrayList<TetherInterfaceStateMachine> notifyList,
                                    SharedLog log) {
    ...
    private LinkProperties getInterfaceIPv6LinkProperties(TetherInterfaceStateMachine sm) {
        ...
        if (currentActive != null && currentActive.tism == sm) {
            ...
            /// M: Support IPv6 only scenario for machine testing
    ...
    private static boolean canTetherIPv6(NetworkState ns, SharedLog sharedLog) {
        ...
        /// Support IPv6 only scenario for machine testing @{
    ...
    /// M: Add for IPv6 only scenario for machine testing
