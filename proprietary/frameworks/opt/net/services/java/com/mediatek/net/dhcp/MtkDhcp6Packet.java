...
abstract class MtkDhcp6Packet {
    ...
    /**
     * DHCP Optional Type: Status Code.
     */
    ...
    protected MtkDhcp6Packet(byte[] transId, Inet6Address sourceIP,
    ...
    public byte[] getClientId() {
        ...
        buffer.put(MtkDhcp6Client.getTimeStamp());
    ...
    /**
     * Creates a concrete MtkDhcp6Packet from the supplied ByteBuffer.  The
     ...
     * in object fields.
     */
    public static MtkDhcp6Packet decodeFullPacket(ByteBuffer packet) {
        // bootp parameters
        byte[] transactionId;
        short secs;
        byte[] clientMac = null;
                ...
                if (optionType == DHCP_OPTION_END) {
                    ...
                    switch (optionType) {
                        ...
                        case OPTION_STATUS_CODE:
                            expectedLen = optionLen;
                            statusCode = packet.getShort() & 0xFFFF;
                            break;
     ...
     */
    public static MtkDhcp6Packet decodeFullPacket(byte[] packet, int length) {
    ...
    public static ByteBuffer buildSolicitPacket(byte[] transactionId,
        ...
        MtkDhcp6Packet pkt = new MtkDhcp6SolicitPacket(
    ...
    public static ByteBuffer buildRequestPacket(
        ...
        MtkDhcp6Packet pkt = new MtkDhcp6RequestPacket(transactionId, clientMac);
    ...
    public static ByteBuffer buildInfoRequestPacket(
        ...
        MtkDhcp6Packet pkt = new MtkDhcp6InfoRequestPacket(transactionId, clientMac);
        pkt.mRequestedParams = expectedParams;
        ByteBuffer result = pkt.buildPacket(DHCP_SERVER, DHCP_CLIENT);
        return result;
    }
    ...
    public static ByteBuffer buildRenewPacket(
        ...
        MtkDhcp6Packet pkt = new MtkDhcp6RenewPacket(transactionId, clientMac);
        pkt.mRequestedIp = requestedIpAddress;
        pkt.mServerIdentifier = serverIdentifier;
        ByteBuffer result = pkt.buildPacket(DHCP_SERVER, DHCP_CLIENT);
        return result;
    ...
    public static ByteBuffer buildRebindPacket(
        ...
        byte[] clientMac, Inet6Address requestedIpAddress,
        byte[]  serverIdentifier, byte[] requestedParams) {
        MtkDhcp6Packet pkt = new MtkDhcp6RebindPacket(transactionId, clientMac);
        pkt.mRequestedIp = requestedIpAddress;
        pkt.mServerIdentifier = serverIdentifier;
        ByteBuffer result = pkt.buildPacket(DHCP_SERVER, DHCP_CLIENT);
        return result;
