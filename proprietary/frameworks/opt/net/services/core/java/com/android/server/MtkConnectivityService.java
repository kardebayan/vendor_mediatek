...
public class MtkConnectivityService extends ConnectivityService {
    ...
    protected MtkConnectivityService(Context context, INetworkManagementService netManager,
        ...
        if (DBG) log("MtkConnectivityService starting up");
    ...
    public NetworkInfo getActiveNetworkInfo() {
        ...
        if (VDBG) log("uid:" + uid + " getActiveNetworkInfo = " + state.networkInfo);
    ...
    public NetworkInfo[] getAllNetworkInfo() {
        ...
        for (int networkType = 0; networkType <= ConnectivityManager.MAX_AOSP_NETWORK_TYPE;
                networkType++) {
    ...
    private final INetworkPolicyListener mPolicyListener = new NetworkPolicyManager.Listener() {
        ...
        public void onRestrictBackgroundChanged(boolean restrictBackground) {
            ...
            if (restrictBackground) {
                ...
                if (mTethering.getTetheredIfaces().length > 0) {
    ...
    private void handleRemoveNetworkRequest(final NetworkRequestInfo nri) {
        ...
        if (nri.request.isRequest()) {
            ...
            // TODO: remove this code once we know that the Slog.e is never hit.
            //
...
//        }
    ...
    private void rematchNetworkAndRequests(NetworkAgentInfo newNetwork,
        ...
        if (wasBackgroundNetwork != newNetwork.isBackgroundNetwork()) {
            ...
            // capability and does not affect the network's score (see the Slog.e call above).
