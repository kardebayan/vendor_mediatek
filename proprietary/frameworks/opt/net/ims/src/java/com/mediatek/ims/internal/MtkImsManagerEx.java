...
public class MtkImsManagerEx {
    ...
    *
    * @return return the current MD platform supports how many IMS protocols.
    *       1: single IMS
    *       2 and more indicate multiple IMS.
    *       Other means error
    ...
    */
    public int getModemMultiImsCount() throws ImsException {
        ...
        checkAndThrowExceptionIfServiceUnavailable();
        try {
            multiImsCount = mMtkImsService.getModemMultiImsCount();
        } catch (RemoteException e) {
            throw new ImsException("getModemMultiImsCount()", e,
                    ImsReasonInfo.CODE_LOCAL_IMS_SERVICE_DOWN);
        }
        log("getModemMultiImsCount=" + multiImsCount);
