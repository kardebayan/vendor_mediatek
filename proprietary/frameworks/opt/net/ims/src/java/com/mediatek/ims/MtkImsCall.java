...
public class MtkImsCall extends ImsCall {
    ...
    public MtkImsCall(Context context, ImsCallProfile profile) {
        ...
        mOpImsCall = OpImsFwkFactoryBase.getInstance().makeOpImsCall();
    }
    ...
    public static class Listener extends ImsCall.Listener {
        ...
        public void onCallRedialEcc(ImsCall imsCall) {
            // no-op
        }
    }
    ...
    protected void setTransientSessionAsPrimary(ImsCallSession transientSession) {
        synchronized (MtkImsCall.this) {
            ...
            if (mSession != null) {
                ...
                // ALPS02441894. Need to close CallSessionProxy to avoid leak.
                mSession.close();
            }
    ...
    public class MtkImsCallSessionListenerProxy extends ImsCallSessionListenerProxy {
        ...
        public void callSessionTextCapabilityChanged(ImsCallSession session,
            ...
            mOpImsCall.callSessionTextCapabilityChanged(listener, MtkImsCall.this,
        ...
        public void callSessionRttModifyRequestReceived(ImsCallSession session,
            ...
            if (!callProfile.mMediaProfile.isRttCall()) {
                logi("callSessionRttModifyRequestReceived:: receive a downgrade.");
                mOpImsCall.notifyRttDowngradeEvent(listener, MtkImsCall.this);
            }
            super.callSessionRttModifyRequestReceived(session, callProfile);
        }
        ...
        public void callSessionRttEventReceived(ImsCallSession session, int event) {
            ...
            mOpImsCall.callSessionRttEventReceived(listener, MtkImsCall.this, event);
        }
        ...
        public void callSessionRedialEcc(ImsCallSession session) {
            ...
            if (listener != null && listener instanceof MtkImsCall.Listener) {
                try {
                    ((MtkImsCall.Listener)listener).onCallRedialEcc(MtkImsCall.this);
                } catch (Throwable t) {
    ...
    public void sendRttDowngradeRequest() {
        synchronized (mLockObj) {
            ...
            mOpImsCall.sendRttDowngradeRequest(mCallProfile, ((MtkImsCallSession) mSession));
        }
    }
    /**
     * modify RTT call mode
     *
     * @hide
     */
    public void setRttMode(int mode) {
        mOpImsCall.setRttMode(mode, mCallProfile);
    }
