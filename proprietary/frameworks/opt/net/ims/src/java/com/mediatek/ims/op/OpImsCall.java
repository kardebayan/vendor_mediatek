...
public interface OpImsCall {
    void callSessionTextCapabilityChanged(ImsCall.Listener listener, MtkImsCall mtkImsCall,
            int localCapability, int remoteCapability,
            int localTextStatus, int realRemoteCapability);

    void callSessionRttEventReceived(ImsCall.Listener listener, MtkImsCall mtkImsCall,
            int event);

    void sendRttDowngradeRequest(ImsCallProfile callProfile, MtkImsCallSession session);
    void setRttMode(int mode, ImsCallProfile callProfile);
